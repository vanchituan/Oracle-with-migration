...
(function (a) {
    ...
    a.jqChartSprintf = function () {
        ...
        return h.replace(a.jqChartSprintf.regex, function (t, s, q, a, w, h, m) {
            ...
            switch (m) {
                ...
                case "g":
                case "G":
                    var o = +i, p = o < 0 ? "-" : n, v = (["toExponential", "toFixed", "toPrecision"])["efg".indexOf(m.toLowerCase())], u = (["toString", "toUpperCase"])["eEfFgG".indexOf(m) % 2];
                    i = p + Math.abs(o)[v](h);
    ...
    a.jqChartDateFormatter = function () {
        var e = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g, d = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, c = /[^-+\dA-Z]/g, b = function (a, b) {
            a = String(a);
            b = b || 2;
            while (a.length < b)
                a = "0" + a;
        ...
        return function (f, h, l) {
            ...
            var j = l ? "getUTC" : "get", o = f[j + "Date"](), r = f[j + "Day"](), n = f[j + "Month"](), u = f[j + "FullYear"](), i = f[j + "Hours"](), s = f[j + "Minutes"](), t = f[j + "Seconds"](), m = f[j + "Milliseconds"](), p = l ? 0 : f.getTimezoneOffset(), q = { d: o, dd: b(o), ddd: k.dayNames[r], dddd: k.dayNames[r + 7], m: n + 1, mm: b(n + 1), mmm: k.monthNames[n], mmmm: k.monthNames[n + 12], yy: String(u).slice(2), yyyy: u, h: i % 12 || 12, hh: b(i % 12 || 12), H: i, HH: b(i), M: s, MM: b(s), s: t, ss: b(t), l: b(m, 3), L: b(m > 99 ? Math.round(m / 10) : m), t: i < 12 ? g[0].charAt(0) || "" : g[1].charAt(0) || "", tt: i < 12 ? g[0] : g[1], T: i < 12 ? g[2].charAt(0) || "" : g[3].charAt(0) || "", TT: i < 12 ? g[2] : g[3], Z: l ? "UTC" : (String(f).match(d) || [""]).pop().replace(c, ""), o: (p > 0 ? "-" : "+") + b(Math.floor(Math.abs(p) / 60) * 100 + Math.abs(p) % 60, 4), S: k.s(o) };
    ...
    a.jqChartDateFormat = {
        masks: { shortDate: "m/d/yyyy", shortTime: "h:MM TT", longTime: "h:MM:ss TT" }, dayNames: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], amPm: ["am", "pm", "AM", "PM"], s: function (a) {
    ...
    function tb(a, b, c, d, e) {
        var f = { enabled: true, delayTime: 0, duration: 2 };
        if (!a)
            return;
    ...
    d.prototype = {
        _createElements: function (c) {
            ...
            if (!d.isTouchDevice) {
                ...
                c.jqMouseCapture({ down: a.proxy(b._mouseDown, this), move: a.proxy(b._mouseMove, this), up: a.proxy(b._mouseUp, this) });
            ...
            b.width = 10;
            b.height = 10;
            a(b).css({ position: "absolute", left: 0, top: 0 });
            if (d.use_excanvas) {
            ...
            var a = this.locOffset, f = c - a.left, g = d - a.top, e = { x: c, y: d, locX: f, locY: g };
            this.mouseInput = e
            ...
            for (var c = this.locOffset, d = [], a = 0; a < b.length; a++) {
                ...
                d.push({ x: f, y: g, locX: h, locY: i })
            }
            this.touchInput = d
        }, _getLocOffset: function () {
            var b = this.elem.offset(), c = parseFloat(a(document.body).css("borderLeftWidth"));
            if (!isNaN(c))
                b.left += c;
            ...
            var k = this.tooltip.outerWidth(true), f = this.tooltip.outerHeight(true), h = this._width, e = this._height, j = d[0]._getTooltipPosition(g, k, f, h, e), c = j.y, i = d.length, l = this;
            if (i > 1) {
                c = 0;
                a.each(d, function () {
            ...
            this.tooltip.stop();
            this.tooltip.animate({ left: j.x, top: c }, 100)
        ...
        }, _exportToImage: function (c, d) {
            c = c || {};
            var b = a.extend({}, d, c);
            b.type = c.type || "image/png";
            if (c.fileName)
                b.fileName = c.fileName;
            else
                switch (b.type) {
                    case "image/jpeg":
                        b.fileName = "jqChart.jpg";
                        break;
                    case "image/png":
                    default:
                        b.fileName = "jqChart.png"
                }
            var e = this.toJSON(b);
            this._doRequest(b.server, "canvas=" + e, b.method)
        }, _exportToPdf: function (c, d) {
            c = c || {};
            var b = a.extend({}, d, c);
            b.type = "application/pdf";
            b.fileName = c.fileName || "chart.pdf";
            var e = this.toJSON(b);
            this._doRequest(b.server, "canvas=" + e, b.method)
        }, _toJSON: function (c, d) {
            var f = this, a = "{type:'" + d.type + "',fileName:'" + d.fileName + "'";
            ...
            return a + "]}"
        }, _doRequest: function (c, a, d) {
            if (c && a) {
                a = typeof a == "string" ? a : jQuery.param(a);
                var b = "";
                jQuery.each(a.split("&"), function () {
                    var a = this.split("=");
                    b += '<input type="hidden" name="' + a[0] + '" value="' + a[1] + '" />'
                });
                jQuery('<form action="' + c + '" method="' + (d || "post") + '">' + b + "</form>").appendTo("body").submit().remove()
            }
            ...
            this._initTooltip(a);
            var c = a[0].getCenter();
            this._setTooltipPos(a, { locX: c.x, locY: c.y });
            return a
        }
    };
    function jb(a) {
    ...
    jb.prototype = {
        _initDefs: function () {
            a.extend(this, { maxInter200Px: 8, lblMargin: 4, crossOffsetX: 0, crossOffsetY: 0, origin: 0, length: 300, x: 0, y: 0 })
            ...
            var b = new l(c);
            b.isAxisLabel = true;
            b.context = { chart: this.chart, axis: this, text: c };
            a.extend(b, d);
            ...
            if (q) {
                for (var e = [], d = 0; d < n.length; d++) {
                    ...
                    if (f == false)
                        e[c] = { y: k, h: a.height, w: a.width + g, labels: [a] }
                }
                ...
                for (var e = [], d = 0; d < n.length; d++) {
                    ...
                    if (f == false)
                        e[c] = { x: j, w: a.width, h: a.height + g, labels: [a] }
                }
            ...
            var f = 0, e = 0, h = 0, o = 0, l = 0, i = 0, n = 0, m = j, s = this.reversed === true, u = this.labels.position == "inside", r = this.isAxisVertical, g = this.lblMargin, k = 2 * g;
            if (r)
            ...
            a.merge(b, c);
            return { postShapes: b, contextShapes: c }
        }, _getMainLine: function () {
            var b = this.crossOffsetX, c = this.crossOffsetY, a = new i(this.x1 + b, this.y1 + c, this.x2 + b, this.y2 + c);
            ...
            if (!this.actualMaximum)
                return 1;
            var b = this.actualMaximum - this.actualMinimum, a = this.actualVisibleMaximum - this.actualVisibleMinimum, c = a / b;
            return c
            ...
            if (c.majorGridLines)
                this.majorGridLines = new Tb(c.majorGridLines);
            if (c.minorGridLines) {
            ...
            var e = this.actualVisibleMaximum, d = this.actualVisibleMinimum, a = this.length / (e - d) * (f - d), b = this.reversed === true, c = this.isAxisVertical;
            ...
            var e = this.actualVisibleMaximum, a = this.actualVisibleMinimum, b = (f - this.origin) * (e - a) / this.length + a, c = this.reversed === true, d = this.isAxisVertical;
            ...
            return d >= c && d <= a
        }, defaults: { location: "left", labels: { visible: true, fillStyle: "black", lineWidth: 1, font: "11px sans-serif", position: "outside", showLastLabel: true, showFirstLabel: true, hAlign: "center", vAlign: "center" }, title: { text: undefined, font: "14px sans-serif", margin: 2 }, strokeStyle: "black", lineWidth: 1, margin: 5, visible: true, reversed: false, zoomEnabled: false }
    };
    var m = -Number.MAX_VALUE, j = Number.MAX_VALUE;
    function b() {
    }
    b.isNull = function (a) {
    ...
    b.intersection = function (a, c, b, d) {
        ...
        if (e != 0) {
            var g = h / e, j = i / e;
            f = { x: a.x + g * (c.x - a.x), y: a.y + g * (c.y - a.y) }
        }
        return f
    };
    ...
    c.prototype.renderDashedLine = function (f, h, g, i, l, c) {
        var r = function (a, b) {
            ...
            return Math.max(a, b)
        }, d = { thereYet: q, cap: n }, e = { thereYet: q, cap: n };
        c.beginPath();
        if (h - i > 0) {
            e.thereYet = r;
            e.cap = m
    ...
    c.prototype.getCenter = function () {
        return this.center ? this.center : { x: this.x + this.width / 2, y: this.y + this.height / 2 }
    };
    ...
    c.prototype._createGradient = function (j, e) {
        ...
        if (this.yOffset)
            d += this.yOffset;
        var f, b = { x0: 0, y0: 0, x1: 1, y1: 1, r0: 0, r1: 1 };
        a.extend(b, e);
        switch (e.type) {
            case "radialGradient":
                var m = c + b.x0 * this.width, o = d + b.y0 * this.height, k = b.r0 * this.width / 2, n = c + b.x1 * this.width, p = d + b.y1 * this.height, l = b.r1 * this.width / 2;
                f = j.createRadialGradient(m, o, k, n, p, l);
                break;
            default:
                var s = c + b.x0 * this.width, t = d + b.y0 * this.height, r = c + b.x1 * this.width, q = d + b.y1 * this.height;
    ...
    c.prototype._getTooltipOrigin = function () {
        return this.tooltipOrigin ? this.tooltipOrigin : { x: this.x + this.width / 2, y: this.y }
    };
    ...
    k.prototype.render = function (a, l) {
        if (!this.visible)
            return;
        c.prototype.render.call(this, a, l);
        var h = this.strokeStyle != null && this.lineWidth > 0, j = h && Math.floor(this.lineWidth % 2) ? b.roundH : Math.round, i = this.correction || 0;
        i = Math.round(i);
        var f = j(this.x), g = j(this.y), e = Math.round(this.width), d = Math.round(this.height), m = this.context;
        if (this.xDecrease) {
            e -= this.xDecrease;
        ...
        if (this.cornerRadius == 0)
            k.renderRectPath(a, f, g, e, d);
        else
            this.renderRoundedRectPath(a, f, g, e, d);
        this.fillStyle != null && a.fill();
        h && a.stroke()
    };
    k.renderRectPath = function (a, b, c, e, d) {
        a.beginPath();
        a.moveTo(b, c);
        a.lineTo(b + e, c);
        a.lineTo(b + e, c + d);
    ...
    function vb(f, g, a, b, d) {
        ...
        this.center = this.tooltipOrigin = { x: h, y: i }
    }
    vb.prototype = new c;
    vb.constructor = new vb;
    vb.prototype.hitTest = function (g, h) {
        var e = this.x, f = this.y, i = Math.pow(g - e, 2) + Math.pow(h - f, 2);
        if (i > Math.pow(this.radius, 2))
            return false;
        var j = e - g, k = f - h, a = Math.atan2(k, j) + Math.PI;
    ...
    vb.prototype.render = function (a, i) {
        ...
        a.beginPath();
        var g = Math.round(this.x), h = Math.round(this.y), b = this.startAngle, e = this.endAngle;
        if (d.use_excanvas) {
        ...
        a.moveTo(g, h);
        a.arc(g, h, Math.round(this.radius), b, e, false);
        a.closePath();
        this.fillStyle != null && a.fill();
        this.strokeStyle != null && this.lineWidth > 0 && a.stroke()
    };
    vb.prototype.toJSON = function () {
        var a = this, b = "type:'pieSlice',x:" + a.x + ",y:" + a.y + ",radius:" + a.radius + ",startAngle:" + a.startAngle + ",endAngle:" + a.endAngle;
        b += c.prototype.toJSON.call(this);
        return b
    };
    function z() {
    ...
    z.prototype.createHighlightMark = function (c) {
        ...
        if (this.isStepLine)
            f /= 2;
        var h = d.points[f], e = 5, b = new Y(g[c] - e, g[c + 1] - e, e);
        b.fillStyle = b.highlightingFillStyle = this.strokeStyle;
        b.strokeStyle = "white";
        b.lineWidth = 1;
        b.useHitTestArea = true;
        b.context = { series: d.series, chart: d.chart };
    ...
    z.prototype.getCenter = function (g) {
        ...
        return { x: b[a], y: b[a + 1], mark: this.createHighlightMark(a) }
    };
    ...
    S.prototype.hitTest = function (j, a, h) {
        var k = this.context;
        if (k && k.points)
            return z.prototype.hitTest.call(this, j, a, h);
    ...
    l.prototype.renderText = function (b, c, a) {
        var h = this.text && this.text.search(l.separator) != -1;
        if (h) {
            var g = this.text.split(l.separator), d = this.getHeight(), e;
            ...
            for (var f = 0; f < g.length; f++) {
                e = g[f];
                this.fillStyle != null && b.fillText(e, c, a);
                this.strokeStyle != null && b.strokeText(e, c, a);
                a += d
            }
        } else {
            this.fillStyle != null && b.fillText(this.text, c, a);
            this.strokeStyle != null && b.strokeText(this.text, c, a)
        }
    };
    l.prototype.renderBg = function (a) {
        ...
        k.renderRectPath(a, f.x, f.y, d, c);
        a.fill();
        a.fillStyle = this._createGradient(a, this.fillStyle) || "#000000"
    };
    ...
    l.prototype.measure = function (e) {
        ...
        var c = this.getHeight(), a, b, g = this.text && this.text.search(l.separator) != -1;
        if (g) {
    ...
    l.prototype.toJSON = function () {
        ...
        if (!a.text || a.text == "")
            return false;
        var d = "type:'textBlock',x:" + a.x + ",y:" + a.y + ",width:" + a.width + ",height:" + a.height + ",text:'" + a.text + "'";
        d += ",font:'" + a.font + "'";
    ...
    rb.prototype = new c;
    rb.constructor = rb;
    rb.prototype.hitTest = function (b, c, a) {
        return this.boundsHitTest(b, c, a)
    };
    rb.prototype.render = function (e) {
        if (!this.visible)
            return;
    ...
    rb.prototype._createHighlightShape = function (b) {
        var a = new k;
    ...
    function ab(a) {
        this.defaults = { text: "", font: "14px sans-serif", fillStyle: "black", lineWidth: 0, margin: 6 };
        this.x = 0;
        this.y = 0;
        this.setOptions(a)
    }
    ...
    function Sb(b) {
        var c = a.extend(false, {}, this.defaults, { hAlign: "left", vAlign: "top" });
        this.defaults = c;
        this.chart = b
    }
    Sb.prototype = new ab;
    ...
    function wb(a) {
        this.defaults = { visible: true, strokeStyle: "black", lineWidth: 1, lineCap: "butt", lineJoin: "miter", miterLimit: 10, cornerRadius: 10, padding: 4, ignoreOffset: false };
        this.x = 0;
        this.y = 0;
        this.setOptions(a)
    }
    ...
    wb.prototype._render = function (c) {
        var a = this.visible ? this.lineWidth / 2 : 0, f = this.x + a, g = this.y + a, e = this.width - 2 * a, d = this.height - 2 * a, b = new k(f, g, e, d);
    ...
    wb.prototype.getPaddings = function () {
        var b = { left: 0, right: 0, top: 0, bottom: 0 };
        if (!this.visible)
            return b;
    ...
    function Ub(a) {
        this.defaults = { strokeStyle: "black", lineWidth: 1, length: 6, position: "outside", visible: true, zIndex: 2, offset: .4 };
        this.setOptions(a)
    }
    ...
    Kb.prototype = new U;
    Kb.constructor = Kb;
    Kb.prototype.mouseWheel = function (d, c) {
        if (!c)
            return;
        var a = this.view.axes.getZoomableAxes();
        a.length > 0 && d.preventDefault();
        for (var b = 0; b < a.length; b++)
            if (this.view.options.mouseWheelInteractionMode == "scrolling")
    ...
    P.prototype.getTwoTouchPointData = function (b) {
        var a = { x1: b[0].locX, y1: b[0].locY, x2: b[1].locX, y2: b[1].locY };
    ...
    function e(b) {
        ...
        d.call(this, b);
        this.timer = new gc(a.proxy(this.partialUpdate, this));
        this.storyboard = new ac(a.proxy(this._renderShapes, this));
    ...
    e.prototype._setOptions = function (h) {
        ...
        if (typeof c.noDataMessage == "string")
            c.noDataMessage = { text: c.noDataMessage };
    ...
    e.prototype._getClosestShapeAtY = function (c, d) {
        for (var b = null, g = j, i = d.locY, a = c.length - 1; a >= 0; a--) {
            var e = c[a], h = e.getCenter(d).y, f = Math.abs(h - i);
            if (g > f) {
                g = f;
                b = e
            }
    ...
    e.prototype._initCrosshairs = function (a) {
    ...
    e.prototype._renderSelectionRect = function (g, h) {
        ...
        var m = Math.min(c, d), n = Math.min(e, f), l = Math.abs(c - d), j = Math.abs(e - f), i = new k(m, n, l, j);
    ...
    e.prototype._createShapes = function () {
        var b = {}, d = [], f = this.gridArea, c = b.shapes = [];
    ...
    e.prototype._renderShapes = function () {
        ...
        if (j) {
            a(this.canvas).css({ width: f, height: e });
            a(this.chCanvas).css({ width: f, height: e });
            a(this.hlCanvas).css({ width: f, height: e })
        }
    };
    ...
    e.prototype.toJSON = function (j) {
        var e = this.gridArea, d = this.options.shadows, f = d && d.enabled, i = new ec(e.x, e.y, e.width, e.height), h = new bc, d = new Wb(true), g = new Wb(false), c = this.allShapes, b = [];
        a.merge(b, c.shapes);
        if (this.hasData) {
            b.push(i);
            if (f) {
    ...
    hb.prototype.createElements = function (b, e, f, o, m, n) {
        var d = [], g = Math.floor(n / 2), b = Math.round(b), a = Math.round(o), c = Math.round(m);
        if (a > c) {
            var l = c;
            c = a;
            a = l
    ...
    function Yb(a) {
        this.chart = a;
        this.defaults = { visibility: "auto", resetZoomTooltipText: "Reset Zoom (100%)", zoomingTooltipText: "Zoom in to selection area", panningTooltipText: "Pan the chart", hAlign: "right", vAlign: "top" }
    }
    Yb.prototype = {
    ...
    function Z(a) {
        this.defaults = { lineCap: "butt", lineJoin: "miter", miterLimit: 10, lineWidth: 1, size: 8, offset: 0, linkLineWidth: 1, type: "circle" };
        this.setOptions(a)
    }
    ...
    Z.prototype.getShape = function (c, d, b, j, f) {
        ...
        if (e) {
            ...
            e.center = { x: Math.round(c), y: Math.round(d) }
        }
        return e
    };
    ...
    function Tb(a) {
        this.defaults = { strokeStyle: "gray", lineWidth: 1, visible: true };
        this.setOptions(a)
    }
    ...
    function dc(a) {
        this.defaults = { strokeStyle: "gray", lineWidth: 1, zIndex: 0, title: { margin: 2, hAlign: "left", vAlign: "top" } };
        this.setOptions(a)
    }
    dc.prototype = {
    ...
    function cc(a) {
        this.defaults = { lineWidth: 0, fillStyle: "gray", zIndex: 0, title: { margin: 2, hAlign: "left", vAlign: "top" } };
        this.setOptions(a)
    }
    cc.prototype = {
    ...
    function kb(a) {
        this.defaults = { location: "right", title: { text: undefined, margin: 0 }, border: { padding: 2, strokeStyle: "gray", cornerRadius: 6 }, margin: 4, visible: true, font: "12px sans-serif", textLineWidth: 0, inactiveTextLineWidth: 0, allowHideSeries: true, inactiveTextFillStyle: "gray", inactiveFillStyle: "gray", inactiveStrokeStyle: "gray" };
        this._itemMargin = 4;
        this.setOptions(a)
    }
    kb.prototype._isHorizontal = function () {
        return this.location == "top" || this.location == "bottom" ? true : false
    };
    kb.prototype._init = function () {
        this.items = [];
        if (this.visible == false)
            return;
        if (this.customItems)
            for (var d = 0; d < this.customItems.length; d++) {
                ...
                if (b != null && typeof b.text == "string")
                    b.text = { text: b.text };
                var j = { marker: { type: "rectangle", fillStyle: "#418CF0" } };
                b = a.extend(true, {}, j, b || {});
                ...
                c.context = { chart: this.chart, title: c.text };
            ...
            if (this.allowHideSeries)
                e = e || "pointer";
            for (var i = { font: this.font, textStrokeStyle: this.textStrokeStyle, textFillStyle: this.textFillStyle, textLineWidth: this.textLineWidth, cursor: e, inactiveTextFillStyle: this.inactiveTextFillStyle, inactiveTextStrokeStyle: this.inactiveTextStrokeStyle, inactiveTextLineWidth: this.inactiveTextLineWidth, inactiveFillStyle: this.inactiveFillStyle, inactiveStrokeStyle: this.inactiveStrokeStyle }, g = this.chart.series.items, d = 0; d < g.length; d++) {
                var h = g[d];
                if (!h.visible)
                    continue;
    ...
    kb.prototype._measure = function () {
        if (this.visible == false) {
            this.width = 0;
            this.height = 0;
            return
        ...
        this.title._measure();
        var i = this.title.width, g = this.title.height;
        if (this.title.text)
            g += e.top;
        for (var k = this._isHorizontal(), b = 0, a = 0, d = 0, h = 0; h < this.items.length; h++) {
            var c = this.items[h];
            c._measure();
            if (k) {
        ...
        var n = 2 * this.margin + e.left + e.right, o = 2 * this.margin + e.top + e.bottom, j = this.chart.border.getPaddings(), l = this.chart._width - j.left - j.right - n;
        if (k && b > l) {
            var f = Math.floor(l / d) || 1, m = Math.ceil(this.items.length / f);
            this.rows = f;
            this.cellHeight = a + this._itemMargin;
            this.cellWidth = d;
            b = f * d;
            a = m * a + (m - 1) * this._itemMargin
        } else
            this.rows = 0;
        i = Math.max(i, b);
        g += a;
        this.width = this.isCustomWidth || i + n;
        this.height = this.isCustomHeight || g + o
    };
    kb.prototype._arrange = function () {
        if (this.visible == false)
            return;
    ...
    kb.prototype._handleEvent = function (e, d) {
        if (!this.allowHideSeries)
            return;
    ...
    kb.prototype.setOptions = function (b) {
        if (b != null && typeof b.title == "string") {
            b.title = { text: b.title };
            a.extend(b.title, this.defaults.title)
        }
    ...
    function sb(a) {
        this.defaults = { font: "12px sans-serif", textFillStyle: "black", textLineWidth: 0 };
        this.lblMargin = 4;
        this.setOptions(a)
    }
    sb.prototype._measure = function () {
        var a;
        if (this.text)
            a = this.textBlock.measure(this.chart.ctx);
        else
    ...
    sb.prototype._arrange = function () {
    ...
    sb.prototype._render = function (c) {
        var b = [];
    ...
    sb.prototype.setOptions = function (c) {
    ...
    B.prototype._arrangeRenderer = function (a) {
        ...
        h.css({ left: f, top: g, width: e, height: c });
        b.width = e;
        b.height = c;
        a.offsetX = -f;
        a.offsetY = -g
        ...
        a.each(d, function () {
            ...
            for (var h = a.lineWidth, o = h / 2, n = b._getIntervals(j, a, true), m = 0; m < n.length; m++) {
                ...
                if (l >= b.actualVisibleMaximum)
                    continue;
                var d = b.getPosition(l), p = b._getNextPosition(l, i), f = b.getPosition(p), g;
                if (b.isAxisVertical)
                    g = new k(c.x + o, Math.min(d, f), c.width - h, Math.abs(f - d));
                else
                    g = new k(Math.min(d, f), c.y + o, Math.abs(f - d), c.height - h);
                a._setSettings(g);
                e.push(g)
            }
        });
    ...
    B.prototype._getPlotLines = function (h, o) {
        ...
        for (var e = this, k = [], l = [], j = 0; j < g.length; j++) {
            ...
            if (b.fitInRange(d.zIndex, 0, 2) != o)
                continue;
            var f = d.lineWidth / 2, n = h.getPosition(d.value), c = new ab(d.title);
            c.chart = this.chart;
            c._measure();
            if (h.isAxisVertical) {
                y1 = y2 = n;
    ...
    B.prototype._getPlotBands = function (g, u) {
        ...
        for (var l = this, q = [], r = [], p = 0; p < j.length; p++) {
            ...
            if (b.fitInRange(d.zIndex, 0, 2) != u)
                continue;
            var o = d.lineWidth, t = o / 2, m = g.getPosition(d.from), n = g.getPosition(d.to), h, i, f, e;
            if (g.isAxisVertical) {
                h = l.x + t;
                i = Math.min(m, n);
                f = l.width - o;
    ...
    x.prototype._findStackedClusters = function (h, e) {
        ...
        return { index: i, count: c, groupIndex: l, groupCount: k }
    };
    ...
    f.prototype = {
        _getMarker: function (j, k, c, l, h, i, g) {
            ...
            var a = this._correctMarkerPosition(d, e, c), h = this._getMarker(a.x, a.y, l, c, f, k, g), j = this.markers.offset, b = null;
            if (j) {
                b = new i(d, e, a.x, a.y);
                this.markers._setLineSettings(b);
                this._setMarkerLinkLineSettings(b)
            }
            return { marker: h, line: b, offset: a.offset }
            ...
            return { x: e, y: b, offset: a }
        }, _addMarkerAndLabel: function (i, p, l, m, a, k, g, e, o, c) {
            if (!b.isNull(g) && !this.realXAxis.isValueVisible(g))
                return;
            var j = 0, q = !b.isNull(g) ? g : a;
            if (!c)
                c = { chart: this.chart, series: this, dataItem: this.arrData[a], index: a, x: this.realXAxis._getValue(q), y: e };
            if (this.markers && this.markers.isVisible() && this.realYAxis.isValueVisible(e)) {
                var n = c.dataItem[2], d = this._addMarker(l, m, null, e, n, a, c);
                if (d.marker) {
            ...
            if (this.labels && this.labels.visible !== false) {
                var h = this._getLabelValue(e, a);
                if (this.labels.valueType == "percentage")
                    h = c.percentage;
                var f = this._getDataPointLabel(e, l, m, o + j, h);
                f.context = c;
                this.chart.elem.trigger("dataPointLabelCreating", f);
                p.push(f);
                this._addShapeAnimation(f, a, k)
            }
            ...
            if (!b || b.enabled === false)
                return;
            var a = new zb(b, e, "visible", false, true), c = a.duration / f, d = a.delayTime + g * c;
            a.delayTime = d;
            a.duration = c;
            ...
            if (!a || a.enabled === false)
                return;
            var c = new tb(a, b, "length", 0, b.getLength());
            ...
            if (a && this.hasErrorBars && this.arrData)
                this.errorBarsObj = new ub(this, a)
            ...
            for (var h = this.nullIndexes = [], e, d, f, g, a = 0; a < c.length; a++) {
                e = c[a];
                d = b.isNull(e);
                if (this.isSingleArrData) {
                    if (d) {
                        h.push(a);
                        c[a] = b.calcNullValue(c, a, "vl")
                    }
                } else {
                    f = d || b.isNull(e[0]);
                    g = d || b.isNull(e[1]);
                    ...
                    if (d)
                        c[a] = [];
                    if (f)
                        c[a][0] = b.calcNullValue(c, a, "x", this.xAxisType);
                    if (g)
                        c[a][1] = b.calcNullValue(c, a, "y")
                }
            }
            ...
            if (this.data)
                ...
                var c = this.chart.arrDataSource;
                if (c) {
                    var j = this.xValuesField, h = this.fromValuesField, i = this.toValuesField, g = b.processDataField(c, j), e = b.processDataField(c, h), f = b.processDataField(c, i);
                    if (g && e && f)
                        this.arrData = b.mergeArrays([g, e, f])
                }
            }
            this._processXAxisType()
            ...
            if (this.realYAxis.zoomEnabled)
                return;
            var a = this.realXAxis, e = a.visibleMinimum || a.minimum, d = a.visibleMaximum || a.maximum, n = !b.isNull(e), l = !b.isNull(d);
            if (!n && !l)
                return;
            if (a.skipEmptyDays) {
            ...
            for (var o = this.arrData, g = j, f = m, q = o.length, k = 0; k < q; k++) {
                var i = o[k];
                if (i == null)
                    continue;
                var c = i[1];
            ...
            if (this.realYAxis.zoomEnabled)
                return;
            var e = this.realXAxis, p = e.visibleMinimum || e.minimum, o = e.visibleMaximum || e.maximum, l = !b.isNull(p), k = !b.isNull(o);
            if (!l && !k)
                return;
            ...
            if (this.realYAxis.zoomEnabled)
                return;
            var d = this.realXAxis, n = d.visibleMinimum || d.minimum, l = d.visibleMaximum || d.maximum, i = !b.isNull(n), h = !b.isNull(l);
            if (!i && !h)
                return;
            ...
            for (var o = this.arrData, g = j, f = m, r = o.length, i = 0; i < r; i++) {
                var h = o[i];
                if (h == null)
                    continue;
                var p = h[0];
            ...
            for (var n = j, l = m, k = j, i = m, g = [], u = r.length, p = {}, f = 0; f < u; f++) {
                var c = r[f];
                if (c == null) {
                    g.push((f + 1).toString());
                    continue
                ...
                for (var q = this._getXValue(c, f), b = { positive: 0, negative: 0 }, e = null, o = t.index - 1; o >= 0; o--) {
                    e = s[o].dataValues[q];
                    if (e) {
                ...
                if (c > 0) {
                    ...
                    b.value = 0;
                p[q] = b;
                l = Math.max(l, b.value);
                n = Math.min(n, b.value)
            }
            var h = { min: n, max: l, dataValues: p };
            if (this.xAxisType == "CategoryAxis")
                h.categories = g;
            else {
                h.minX = k;
            ...
            if (this.realYAxis.zoomEnabled)
                return;
            var e = this.realXAxis, i = e.visibleMinimum || e.minimum, h = e.visibleMaximum || e.maximum, l = !b.isNull(i), k = !b.isNull(h);
            if (!l && !k)
                return;
            if (e.skipEmptyDays) {
                i = e._addEmptyDaysOffset(i);
                h = e._addEmptyDaysOffset(h)
            }
            for (var o = j, n = m, x = s.length, q = {}, g = 0; g < x; g++) {
                var d = s[g];
                if (d == null)
                    continue;
                if (this.xAxisType == "CategoryAxis") {
                ...
                for (var r = this._getXValue(d, g), c = { positive: 0, negative: 0 }, f = null, p = w.index - 1; p >= 0; p--) {
                    f = u[p].dataValues[r];
                    if (f) {
            ...
            var v = { min: o, max: n, dataValues: q };
            return v
        }, _createXAxis: function () {
            var b = { location: "bottom", orientation: "x" }, a;
            switch (this.xAxisType) {
                case "DateTimeAxis":
                    a = new p(b);
                    break;
            ...
            var a = new o({ location: "left", orientation: "y" });
            a.chart = this.chart;
            return a
            ...
            var j = { chart: this.chart, series: this }, e = a.extend(false, {}, d, { context: j, text: g, marker: c });
            if (!this.showInScene) {
            ...
            if (this.labels && this.labels.visible !== false) {
                ...
                c = { width: 0, height: 0 };
            var f = d.isVertical(), k = this.isVertical, b;
            if (f)
            ...
            var g = i >= this.realYAxis.getCrossing(), h = this._getLabelText(f), b = new l(h);
            ...
            return a
        }, _calcColumnScale: function (l) {
            for (var f = [], b = 0; b < l.length; b++)
                a.merge(f, l[b].arrData || []);
            f.sort(function (a, b) {
                return !a || !b ? 0 : a[0] - b[0]
            });
            for (var d, e, c, h = j, b = 0; b < f.length - 1; b++) {
                c = f[b];
                if (!c)
                    continue;
                d = c[0];
            ...
            var i = this.realXAxis, k = i.series, g = k.maxX - k.minX;
            if (i.skipEmptyDays)
                g -= i.totalEmptyDaysTicks;
            g = Math.min(.5, h / g);
            return g
            ...
            if (!this.arrData || !this.isInScene())
                return;
            switch (this.xAxisType) {
                case "LinearAxis":
                case "DateTimeAxis":
            ...
            this.options = c;
            if (c)
                this.emptyPointStyleObj = new Xb(b.emptyPointStyle);
            if (b.markers != null)
                this.markers = new Z(b.markers)
        }, isInScene: function () {
            return this.visible && this.showInScene
        }, defaults: { lineCap: "butt", lineJoin: "round", miterLimit: 10, pointWidth: .6, minimumWidth: 1, nullHandling: "break", visible: true, lineWidth: 1, strokeStyle: null, showInLegend: true, showInScene: true }
    };
    function A(b) {
        var c = a.extend(true, {}, this.defaults, { lineWidth: 2, markers: {} });
        this.defaults = c;
        f.call(this, b);
    ...
    A.prototype._renderCatData = function (n) {
        for (var o = this.arrData, p = o.length, f = this.markers != null && this.markers.isVisible(), c = [], i = [], m = [], k = [], q = f ? this.markers.size / 2 : 0, h, j, r, d, e = 0; e < p; e++) {
            var g = o[e];
            if (g === null) {
                c.push(null);
                c.push(null);
            ...
            c.push(h);
            c.push(j);
            !f && i.push({ dataItem: g, index: e, x: this.realXAxis._getValue(e), y: d });
            if (this.realYAxis.isValueVisible(d) === false)
                continue;
            this._addMarkerAndLabel(m, k, h, j, e, p, null, d, q)
        }
        var l = this._createShape(c, n);
        if (!f && l)
            l.context = { chart: this.chart, series: this, points: i };
        else
            a.merge(n, m);
        return k
    };
    A.prototype._renderLinearData = function (j) {
        var q = this.arrData, k = q.length, d = this.markers != null && this.markers.isVisible(), r = this.labels != null && this.labels.visible !== false;
        if (k > 1e3 && d == false && r == false) {
            this._renderLargeXYData(j);
            return
        }
        for (var c = [], h = [], p = [], n = [], s = d ? this.markers.size / 2 : 0, l, m, f, e, g = 0; g < k; g++) {
            var i = q[g];
            if (i === null) {
                c.push(null);
                c.push(null);
            ...
            c.push(l);
            c.push(m);
            !d && h.push({ dataItem: i, index: g, x: f, y: e });
            if (this.realYAxis.isValueVisible(e) === false)
                continue;
            this._addMarkerAndLabel(p, n, l, m, g, k, f, e, s)
        }
        var o = this._createShape(c, j);
        if (!d && o)
            o.context = { chart: this.chart, series: this, points: h };
        else
            a.merge(j, p);
        return n
    };
    A.prototype._renderLargeXYData = function (t) {
        for (var n = this.arrData, x = n.length, w = this.chart.gridArea.width, s = this.chart.gridArea.height, i = this.realXAxis, j = this.realYAxis, u = 2 * (i.actualVisibleMaximum - i.actualVisibleMinimum) / w, v = 2 * (j.actualVisibleMaximum - j.actualVisibleMinimum) / s, a = [], q, r, c, b, o = 0, p = 0, k = 0, l = 0, d, f, g, e = [], h = 0; h < x; h++) {
            ...
            a.push(q);
            a.push(r);
            e.push({ dataItem: d, index: h, x: c, y: b })
        }
        var m = this._createShape(a, t);
        if (m)
            m.context = { chart: this.chart, series: this, points: e }
    };
    ...
    function eb(b) {
        var c = a.extend(true, {}, this.defaults, { lineWidth: 0, markers: null });
        this.defaults = c;
        f.call(this, b)
    }
    eb.prototype = new A;
    ...
    s.prototype._createXAxis = function () {
        var b = { location: "left", orientation: "x" }, a;
        switch (this.xAxisType) {
            case "DateTimeAxis":
                a = new p(b);
                break;
    ...
    s.prototype._createYAxis = function () {
        var a = new o({ location: "bottom", orientation: "y" });
        a.chart = this.chart;
        return a
    };
    ...
    s.prototype._renderCatData = function (p) {
        ...
        e = Math.round(e);
        var q = this.chart.series._findClusters(this, this.type), m = r.length, C = i.height / this.realXAxis.getZoom(), x = C / m, F = x / q.count, f = Math.round(this.pointWidth * F), B = q.count * f, o = (x - B) / 2;
        o = Math.round(o + q.index * f);
        f = Math.max(f, this.minimumWidth);
        for (var v = [], s = [], D = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, c, l, d = 0; d < m; d++) {
            var n = r[d];
            if (n == null)
                continue;
            var G = d, h;
            ...
            if (h == null)
                continue;
            l = Math.round(this.realXAxis.getCatPosition(G) - o - f);
            ...
            var u = { chart: this.chart, series: this, dataItem: r[d], index: d, x: this.realXAxis._getValue(d), y: h }, j = new k(c, l, g, f);
            j.context = u;
            j.center = { x: Math.round(A), y: Math.round(l + f / 2) };
            this._setShapeSettings(j, d);
            p.push(j);
            this._addAnimation(j, d, m);
            l += f / 2;
            this._addMarkerAndLabel(v, s, A, l, d, m, null, h, D, u)
        }
        this._createErrorBars(p);
        a.merge(p, v);
        return s
    };
    s.prototype._renderLinearData = function (n) {
        var o = this.arrData, g = this.chart.gridArea, x = g.x, E = x + g.width, d = this.realYAxis.getCrossingPosition();
        d = b.fitInRange(d, x, E);
        d = Math.round(d);
        var p = o.length, A = g.height / this.realXAxis.getZoom(), D = this._getSeriesFromThisType(), C = this._calcColumnScale(D) * A, m = this.pointWidth * C;
        m = Math.max(m, this.minimumWidth);
        for (var u = [], r = [], B = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, c, q, i, j, l, e = 0; e < p; e++) {
            l = o[e];
            ...
            if (i == null || j == null)
                continue;
            var t = { chart: this.chart, series: this, dataItem: o[e], index: e, x: i, y: j };
    ...
    s.prototype._addAnimation = function (c, g, f) {
        ...
        if (!b || b.enabled === false)
            return;
        var a = new tb(b, c, "xDecrease", c.width, 0);
    ...
    s.prototype._getDataPointLabel = function (k, g, m, f, h) {
        var i = k <= this.realYAxis.getCrossing(), j = this._getLabelText(h), b = new l(j);
        d.setShadows(b, this, this.chart);
        a.extend(b, this.labels);
        b.measure(this.chart.ctx);
        b.y = m;
    ...
    function cb(b) {
        var c = a.extend(true, {}, this.defaults, { markers: { strokeStyle: null } });
        this.defaults = c;
        f.call(this, b)
    }
    cb.prototype = new f;
    ...
    cb.prototype._render = function (m) {
        ...
        if (!c || !this.isInScene())
            return;
        var o = this.chart, p = o.options, h = p.maxBubbleSize;
        if (!h) {
            var r = o.gridArea;
            h = Math.min(r.width, r.height) * .25
        }
        var g = p.maxBubbleScale;
        if (!g)
            g = this.maxSize;
        for (var i = c.length, j, k, f, d, b, a = 0; a < i; a++) {
            var e = c[a];
            if (e == null)
                continue;
            d = e[0];
            ...
            if (d == null || b == null || f == null)
                continue;
            var u = f / g, q = Math.max(u * h, 0);
            j = this.realXAxis.getPosition(d);
            k = this.realYAxis.getPosition(b);
            if (this.markers && this.markers.isVisible()) {
                var t = { chart: this.chart, series: this, dataItem: c[a], index: a, x: d, y: b, size: f }, l = this._getMarker(j, k, q / 2, null, null, a, t);
                m.push(l);
    ...
    J.prototype = new f;
    J.constructor = J;
    J.prototype._renderCatData = function (p) {
        var r = this.arrData, j = this.chart.gridArea, C = j.y, B = j.y + j.height, d = this.realYAxis.getCrossingPosition();
        d = b.fitInRange(d, C, B);
        d = Math.round(d);
        var q = this.chart.series._findClusters(this, this.type), l = r.length, y = j.width / this.realXAxis.getZoom(), v = y / l, A = v / q.count, f = Math.round(this.pointWidth * A), x = q.count * f, o = (v - x) / 2;
        o = Math.round(o + q.index * f);
        f = Math.max(f, this.minimumWidth);
        for (var u = [], s = [], z = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, g, h, e, c = 0; c < l; c++) {
            var m = r[c];
            if (m == null)
                continue;
            g = c;
            ...
            if (e == null)
                continue;
            g = Math.round(this.realXAxis.getCatPosition(g) + o);
            ...
            var t = { chart: this.chart, series: this, dataItem: r[c], index: c, x: this.realXAxis._getValue(c), y: e }, i = new k(g, h, f, n);
            i.context = t;
            i.center = { x: Math.round(g + f / 2), y: Math.round(w) };
            this._setShapeSettings(i, c);
            p.push(i);
            this._addAnimation(i, c, l);
            if (this.realYAxis.isValueVisible(e) === false)
                continue;
            g += f / 2;
            this._addMarkerAndLabel(u, s, g, w, c, l, null, e, z, t)
        }
        this._createErrorBars(p);
        a.merge(p, u);
        return s
    };
    J.prototype._renderLinearData = function (n) {
        var o = this.arrData, j = this.chart.gridArea, B = j.y, z = j.y + j.height, c = this.realYAxis.getCrossingPosition();
        c = b.fitInRange(c, B, z);
        c = Math.round(c);
        var p = o.length, w = j.width / this.realXAxis.getZoom(), A = this._getSeriesFromThisType(), y = this._calcColumnScale(A) * w, i = this.pointWidth * y;
        i = Math.max(i, this.minimumWidth);
        for (var s = [], q = [], x = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, e, f, u, g, d = 0; d < p; d++) {
            var l = o[d];
            if (l == null || a.isArray(l) == false)
                continue;
            u = e = l[0];
            ...
            if (e == null || g == null)
                continue;
            var r = { chart: this.chart, series: this, dataItem: o[d], index: d, x: e, y: g };
            ...
            var t = e - i / 2, h = new k(t, f, i, m);
            h.context = r;
            h.center = { x: Math.round(t + i / 2), y: Math.round(v) };
    ...
    J.prototype._addAnimation = function (c, g, f) {
        ...
        if (!b || b.enabled === false)
            return;
        var a = new tb(b, c, "yDecrease", c.height, 0);
        this._setIsAnimReversed(c);
        var d = a.duration / f, e = a.delayTime + g * d;
        a.delayTime = e;
        a.duration = d;
    ...
    function h(b) {
        var c = a.extend(true, {}, this.defaults, { margin: 8, startAngle: -90, explodedRadius: 10, hiddenSlices: [], allowExplodeSlices: true, explodedSlices: [], labelsPosition: "inside", labelsAlign: "circle", labelsExtend: 20, leaderLineWidth: 1, leaderLineStrokeStyle: "black" });
        this.defaults = c;
        f.call(this, b)
    }
    h.prototype = new f;
    ...
    h.prototype._processData = function () {
        ...
        if (this.data) {
            ...
            if (!this.dataLabelsType && !this.dataValuesType)
                this.arrData = b.cloneArray(this.data);
            else {
                this.arrData = [];
            ...
            var c = this.chart.arrDataSource;
            if (c) {
                var e = this.dataLabelsField, f = this.dataValuesField, g = b.processDataField(c, e), h = b.processDataField(c, f);
                this.arrData = b.mergeArraysXY(g, h);
                this.expIndexes = [];
                for (var a = 0; a < c.length; a++) {
                    var i = c[a], j = i[this.explodedField];
    ...
    h.prototype._createLabels = function () {
        var B = this.arrData, f = {};
        if (!B)
            return f;
        var m = this.chart.gridArea, J = m.width, I = m.height, A = this._getYValues(), D = A.length, E = this.getTotal(), q = this.margin, g = this._calcRadius({ h: q, v: q });
        if (g < 0)
            return f;
        var r = m.x + J / 2, s = m.y + I / 2, H = Math.PI * 2 / E, o = b.radians(this.startAngle), t = this.explodedRadius;
        if (!this.labels || this.labels.visible === false)
            return f;
        for (var k, y, p = [], o = b.radians(this.startAngle), z = this.labelsPosition == "outside", u = this.hiddenSlices, F = D - u.length, n = 0, d = 0; d < D; d++) {
            if (a.inArray(d, u) != -1) {
                n++;
                continue
            }
            var j = A[d], w = 100 * j / E, v = j, x = o + j * H;
            switch (this.labels.valueType) {
                case "percentage":
                    v = w
            }
            if (j == 0)
                continue;
            var G = this._getLabelText(v), e = (o + x) / 2, c = new l(G);
            c.textBaseline = "top";
            a.extend(c, this.labels);
            c.context = { chart: this.chart, series: this, dataItem: B[d], index: d, value: j, percentage: w };
            this.chart.elem.trigger("dataPointLabelCreating", c);
            var C = c.measure(this.chart.ctx), h = r, i = s;
            y = this.isExploded(d);
            if (y) {
                i = s + t * Math.sin(e);
                h = r + t * Math.cos(e)
            ...
            if (z)
                k = this._getSliceCenter(h, i, e, g + this.labelsExtend);
            else
                k = this._getSliceCenter(h, i, e, g * .6);
            c.x = k.x - C.width / 2;
            c.y = k.y - C.height / 2;
            o = x;
            if (!z && this.isOverlap(c, p))
                continue;
            p.push(c);
            segment = { pt: this._getSliceCenter(h, i, e, g), angle: e, index: d, animIndex: d - n, cx: h, cy: i };
            e = b.normalizeAngle(e + Math.PI / 2);
            segment.isLeft = e > Math.PI;
            c.segment = segment;
            this._addShapeAnimation(c, d - n, F)
        }
        a.extend(f, { x: r, y: s, radius: g, margin: q, labels: p });
        return f
    };
    h.prototype._arrangeLabels = function (c) {
        var j = c.labels;
        if (!j || this.labelsPosition != "outside")
            return { margins: { h: this.margin, v: this.margin }, lines: [] };
        for (var f = [], e = [], u = this._calculateLabelsMargin(j, c), q = c.radius = this._calcRadius(u), a, t, o = m, n = m, b = 0; b < j.length; b++) {
            a = j[b];
            t = a.width;
            if (a.segment.isLeft) {
                f.push(a);
        ...
        var s = [], d, g, k, p, h, i, l = this.explodedRadius;
        for (b = 0; b < f.length; b++) {
            ...
            i = c.y;
            d = g.angle;
            p = this.isExploded(g.index);
            if (p) {
                i += l * Math.sin(d);
                h += l * Math.cos(d)
            }
            k = this._getSliceCenter(h, i, d, q + this.labelsExtend);
            a.x = k.x - a.width - this.labelsExtend;
            a.y = k.y - a.height / 2;
            g.pt = this._getSliceCenter(h, i, d, q)
        }
        var r = this._distancesBetweenLabels(f);
        this._distributeLabels(r, f);
        for (b = 0; b < f.length; b++) {
            a = f[b];
            this._hLabelAlign(a, o, n, c);
    ...
    h.prototype._addLabelLine = function (m, l, t) {
        ...
        a.push(d.pt.x);
        a.push(d.pt.y);
        var h = m.x, f = m.y + m.height / 2, c, e, g, r = new Y(k - i, s - i, i);
        if (d.isLeft) {
            h += m.width + p;
            e = h + j;
            c = b.intersection({ x: k, y: s }, d.pt, { x: h, y: f }, { x: e, y: f });
            c = c || { x: e, y: f };
            c.x = Math.max(c.x, e);
            ...
            h -= p;
            e = h - j;
            c = b.intersection({ x: l.x, y: l.y }, d.pt, { x: h, y: f }, { x: e, y: f });
            c = c || { x: e, y: f };
            c.x = Math.min(c.x, e);
            if (r.hitTest(c.x, c.y) || c.x < k) {
                g = k + i + j;
    ...
    h.prototype._renderSlices = function (A, z) {
        var p = this.arrData;
        if (!p)
            return;
        var f = this.chart.gridArea, D = f.width, C = f.height, n = this._getYValues(), q = n.length, r = this.getTotal(), m = this._calcRadius(z);
        if (m < 0)
            return;
        for (var u = f.x + D / 2, v = f.y + C / 2, B = Math.PI * 2 / r, e = b.radians(this.startAngle), E = this.fillStyles, i = this.explodedRadius, k = this.hiddenSlices, x = q - k.length, j = 0, l, c = 0; c < q; c++) {
            if (a.inArray(c, k) != -1) {
                j++;
                continue
            }
            var h = n[c], w = 100 * h / r, g = e + h * B, s = u, t = v;
            l = this.isExploded(c);
            if (l) {
                var o = (e + g) / 2;
                t = v + i * Math.sin(o);
            ...
            var d = new vb(s, t, m, e, g), y = { chart: this.chart, series: this, dataItem: p[c], index: c, value: h, percentage: w };
            d.context = y;
            this._setShapeSettings(d, c);
            d.fillStyle = this.getSliceColor(c);
            A.push(d);
            this._addSliceAnimation(d, c - j, x);
            e = g
        }
    };
    ...
    h.prototype._getSliceCenter = function (c, d, b, a) {
        return { x: c + a * Math.cos(b), y: d + a * Math.sin(b) }
    };
    h.prototype._getLegendItems = function (c) {
        ...
        for (var m = this._getYValues(), h, o = i.length, b = 0; b < o; b++) {
            ...
            var l = { chart: this.chart, series: this, dataItem: e, index: b, value: m[b] }, f = a.extend(false, {}, c, { context: l, text: h, marker: g });
            if (!k) {
    ...
    h.prototype._getTooltip = function (a) {
        var d = this.chart.stringFormat(a.percentage, "%.2f%%"), b = "<b>" + a.value + " (" + d + ")</b><br/>", c = a.dataItem[0];
        if (c)
            b = c + "<br/>" + b;
        return b
    };
    h.prototype._addSliceAnimation = function (c, g, f) {
        ...
        if (!b || b.enabled === false)
            return;
        var a = new tb(b, c, "endAngle", c.startAngle, c.endAngle), d = a.duration / f, e = a.delayTime + g * d;
        a.delayTime = e;
        a.duration = d;
        this.chart.storyboard.addAnimation(a)
    };
    ...
    function Qb(b) {
        var c = a.extend(true, {}, this.defaults, { markers: { type: "diamond" } });
        this.defaults = c;
        f.call(this, b)
    }
    Qb.prototype = new A;
    ...
    Pb.prototype = new A;
    Pb.constructor = Pb;
    Pb.prototype._createShape = function (e, k) {
        for (var j, g, f, i, c, b = [], h = e.length, a = 0; a < h; a += 2) {
            j = e[a];
            g = e[a + 1];
            if (!j || !g)
                continue;
            ...
            if (c != a + 2 && this.nullHandling == "break") {
                b.push(null);
                b.push(null)
            } else if (f && g) {
                b.push(f);
    ...
    function v(b) {
        var c = a.extend(true, {}, this.defaults, { stackedGroupName: "" });
        this.defaults = c;
        A.call(this, b);
    ...
    v.prototype._render = function (t) {
        ...
        if (!g || !this.isInScene())
            return;
        for (var A = this.chart.series._findStackedClusters(this, this.type), n = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), v = g.length, i = this.markers != null && this.markers.isVisible(), k = [], r = [], s = [], p = [], x = i ? this.markers.size / 2 : 0, y = this.xAxisType, l, m, c, h, d, f, b = 0; b < v; b++) {
            c = g[b];
            if (c == null)
                continue;
            var j = this._getXValue(c, b);
            c = this.dataValues[j];
            if (c == null)
                continue;
            d = this._scaleValue(n, c.value, j);
            if (y == "CategoryAxis") {
                h = b + .5;
                f = this.realXAxis._getValue(b)
            } else {
                h = g[b][0];
                f = h
            }
            l = this.realXAxis.getPosition(h);
            m = this.realYAxis.getPosition(d);
            k.push(l);
            k.push(m);
            var e = c.actualValue, u = this._getStackedTotal(n, j), w = e > 0 ? u.positive : u.negative, o = w != 0 ? 100 * Math.abs(e) / Math.abs(w) : 0, z = { chart: this.chart, series: this, dataItem: c, index: b, x: f, y: d, value: e, percentage: o };
            !i && r.push({ dataItem: c, index: b, x: f, y: d, value: e, percentage: o });
            if (this.realYAxis.isValueVisible(d) === false)
                continue;
            this._addMarkerAndLabel(s, p, l, m, b, v, null, d, x, z)
        }
        var q = this._createShape(k, t);
        if (!i && q)
            q.context = { chart: this.chart, series: this, points: r };
        else
            a.merge(t, s);
        return p
    };
    ...
    nb.prototype = new gb;
    nb.constructor = nb;
    nb.prototype._initVisibleData = function () {
        gb.prototype._initVisibleData.call(this);
        this.min = 0;
        this.max = 100
    };
    nb.prototype._scaleValue = function (a, d, b) {
        var c = this._getStackedTotal(a, b).positive || 1;
        return 100 * d / c
    };
    nb.prototype._getTooltip = function (b) {
    ...
    function R(b) {
        var c = a.extend(true, {}, this.defaults, { lineWidth: 0, markers: null, stackedGroupName: "" });
        this.defaults = c;
        f.call(this, b)
    }
    R.prototype = new v;
    ...
    R.prototype._render = function (v) {
        ...
        if (!d || !this.isInScene())
            return;
        for (var o = this.chart.series._findStackedClusters(this, this.type), g = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), u = this.xAxisType, w = d.length, j = [], k = [], n = [], l, r, s, a, f, e, x, i, b = 0; b < w; b++) {
            a = d[b];
            if (a == null)
                continue;
            ...
            if (u == "CategoryAxis") {
                f = b + .5;
                i = this.realXAxis._getValue(b)
            } else {
                f = d[b][0];
                i = f
            }
            e = this._scaleValue(g, a.value, c);
            l = this.realXAxis.getPosition(f);
            r = this.realYAxis.getPosition(e);
            j.push(l);
            j.push(r);
            if (o.index != 0) {
                s = this._getPrevStackedPosition(g, o.index, c, 0, this.realYAxis, e >= 0);
                k.push(l);
                k.push(s)
            }
            var h = a.actualValue, p = this._getStackedTotal(g, c), q = h > 0 ? p.positive : p.negative, t = q != 0 ? 100 * Math.abs(h) / Math.abs(q) : 0;
            n.push({ dataItem: a, index: b, x: i, y: e, value: h, percentage: t })
        }
        var m = this._createShape(j, k, v);
        if (m)
            m.context = { chart: this.chart, series: this, points: n }
    };
    ...
    R.prototype._createShape = function (c, d, b) {
        if (!d.length)
            return eb.prototype._createShape.call(this, c, b);
    ...
    mb.prototype._createShape = function (c, d, b) {
        if (!d.length)
            return yb.prototype._createShape.call(this, c, b);
    ...
    lb.prototype = new mb;
    lb.constructor = lb;
    lb.prototype._initVisibleData = function () {
        v.prototype._initVisibleData.call(this);
        this.min = 0;
        this.max = 100
    };
    lb.prototype._scaleValue = function (a, d, b) {
        var c = this._getStackedTotal(a, b).positive || 1;
        return 100 * d / c
    };
    lb.prototype._getTooltip = function (b) {
        var d = this.chart.stringFormat(b.percentage, "%.2f%%"), a = "<b>" + b.value + " (" + d + ")</b><br/>";
        if (this.title) {
            var e = c.getColorFromFillStyle(this.fillStyle);
            a = '<span style="color:' + e + '">' + this.title + "</span>: " + a
    ...
    K.prototype._renderCatData = function (E) {
        ...
        i = Math.round(i);
        var c = this.chart.series._findStackedClusters(this, this.type), G = s.length, J = r.width / this.realXAxis.getZoom(), C = J / G, M = C / c.groupCount, g = Math.round(this.pointWidth * M), I = c.groupCount * g, v = (C - I) / 2;
        v = Math.round(v + c.groupIndex * g);
        g = Math.max(g, this.minimumWidth);
        for (var B = [], A = [], t = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), K = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, h, e, d = 0; d < G; d++) {
            e = s[d];
            if (e == null)
                continue;
            var q = this._getXValue(e, d);
            e = this.dataValues[q];
            if (e == null)
                continue;
            var m = this._scaleValue(t, e.value, q);
            f = d;
            f = Math.round(this.realXAxis.getCatPosition(f) + v);
            h = Math.round(this.realYAxis.getPosition(m));
            var o = this._getPrevStackedPosition(t, c.index, q, i, this.realYAxis, m >= 0), w = h, p;
            if (h <= o)
                p = o - h;
            else {
                p = h - o;
            ...
            var n = e.actualValue, F = this._getStackedTotal(t, q), H = n > 0 ? F.positive : F.negative, y = H != 0 ? 100 * Math.abs(n) / Math.abs(H) : 0, u = { chart: this.chart, series: this, dataItem: s[d], index: d, value: n, x: this.realXAxis._getValue(d), y: m, percentage: y }, l = new k(f, h, g, p);
            l.context = u;
            l.center = { x: Math.round(f + g / 2), y: Math.round(w) };
            this._setShapeSettings(l, d);
            E.push(l);
            this._addAnimation(l, c.index, c.count);
            f += g / 2;
            if (this.markers && this.realYAxis.isValueVisible(m)) {
                var D = this._getMarker(f, w, null, m, null, d, u);
                B.push(D);
                this._addShapeAnimation(D, c.index, c.count)
            }
            if (this.labels && this.labels.visible !== false && e.actualValue != 0) {
                var x = n;
                switch (this.labels.valueType) {
                    case "percentage":
                        x = y
    ...
    K.prototype._renderLinearData = function (C) {
        ...
        if (!h)
            return;
        var t = this.chart.gridArea, M = t.y, J = t.y + t.height, i = this.realYAxis.getCrossingPosition();
        i = b.fitInRange(i, M, J);
        i = Math.round(i);
        var e = this.chart.series._findStackedClusters(this, this.type), o = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), L = h.length, F = t.width / this.realXAxis.getZoom(), I = this._calcColumnScale(o) * F, n = this.pointWidth * I;
        n = Math.max(n, this.minimumWidth);
        for (var A = [], z = [], G = this.markers && this.markers.isVisible() ? this.markers.size / 2 : 0, f, g, d, c = 0; c < L; c++) {
            d = h[c];
            if (d == null)
                continue;
            var s = this._getXValue(d, c);
            d = this.dataValues[s];
            if (d == null)
                continue;
            var m = this._scaleValue(o, d.value, s);
            f = h[c][0];
            f = Math.round(this.realXAxis.getPosition(f));
            g = Math.round(this.realYAxis.getPosition(m));
            var q = this._getPrevStackedPosition(o, e.index, s, i, this.realYAxis, m >= 0), v = g, r;
            if (g <= q)
                r = q - g;
            else {
                r = g - q;
            ...
            var p = d.actualValue, D = this._getStackedTotal(o, s), E = p > 0 ? D.positive : D.negative, x = E != 0 ? 100 * Math.abs(p) / Math.abs(E) : 0, u = { chart: this.chart, series: this, dataItem: h[c], index: c, value: p, x: h[c][0], y: m, percentage: x }, K = f - n / 2, l = new k(K, g, n, r);
            l.context = u;
            l.center = { x: Math.round(f + n / 2), y: Math.round(v) };
            this._setShapeSettings(l, c);
            C.push(l);
            this._addAnimation(l, e.index, e.count);
            if (this.markers && this.realYAxis.isValueVisible(m)) {
                var B = this._getMarker(f, v, null, m, null, c, u);
                A.push(B);
            ...
            if (this.labels && this.labels.visible !== false && d.actualValue != 0) {
                ...
                var y = this.labels.position == "outside", H = y ? G : -r / 2, j = this._getDataPointLabel(d.actualValue, f, v, H, w);
                if (!y)
                    j.textBaseline = "middle";
                j.context = u;
                this.chart.elem.trigger("dataPointLabelCreating", j);
    ...
    H.prototype._renderCatData = function (E) {
        ...
        j = Math.round(j);
        var c = this.chart.series._findStackedClusters(this, this.type), H = r.length, K = v.height / this.realXAxis.getZoom(), C = K / H, O = C / c.groupCount, g = Math.round(this.pointWidth * O), J = c.groupCount * g, u = (C - J) / 2;
        u = Math.round(u + c.groupIndex * g);
        g = Math.max(g, this.minimumWidth);
        for (var B = [], A = [], s = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), L = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, f, i, e, d = 0; d < H; d++) {
            e = r[d];
            if (e == null)
                continue;
            var p = this._getXValue(e, d);
            e = this.dataValues[p];
            if (e == null)
                continue;
            var m = this._scaleValue(s, e.value, p);
            f = d;
            i = Math.round(this.realXAxis.getCatPosition(f) - u - g);
            f = Math.round(this.realYAxis.getPosition(m));
            var o = this._getPrevStackedPosition(s, c.index, p, j, this.realYAxis, m >= 0), w = f, q;
            if (f <= o)
                q = o - f;
            else {
                q = f - o;
            ...
            var n = e.actualValue, F = this._getStackedTotal(s, p), I = n > 0 ? F.positive : F.negative, y = I != 0 ? 100 * Math.abs(n) / Math.abs(I) : 0, t = { chart: this.chart, series: this, dataItem: r[d], index: d, value: n, x: this.realXAxis._getValue(d), y: m, percentage: y }, l = new k(f, i, q, g);
            l.context = t;
            l.center = { x: Math.round(w), y: Math.round(i + g / 2) };
            this._setShapeSettings(l, d);
            E.push(l);
            this._addAnimation(l, c.index, c.count);
            i += g / 2;
            if (this.markers && this.realYAxis.isValueVisible(m)) {
                var D = this._getMarker(w, i, null, m, null, d, t);
                B.push(D);
                this._addShapeAnimation(D, c.index, c.count)
            }
            if (this.labels && this.labels.visible !== false && e.actualValue != 0) {
                ...
                A.push(h);
                this._addShapeAnimation(h, c.index, c.count)
            }
        }
        a.merge(E, B);
        return A
    ...
    H.prototype._renderLinearData = function (C) {
        ...
        i = Math.round(i);
        var s = this.chart.series._getStackedSeriesFromType(this.type, this.stackedGroupName), f = this.chart.series._findStackedClusters(this, this.type), N = h.length, G = u.height / this.realXAxis.getZoom(), K = this._getSeriesFromThisType(), J = this._calcColumnScale(K) * G, m = this.pointWidth * J;
        m = Math.max(m, this.minimumWidth);
        for (var A = [], z = [], H = this.markers && this.markers.isVisible() ? this.markers.size / 2 + 2 : 2, e, n, d, c = 0; c < N; c++) {
            d = h[c];
            if (d == null)
                continue;
            var q = this._getXValue(d, c);
            d = this.dataValues[q];
            if (d == null)
                continue;
            var l = this._scaleValue(s, d.value, q);
            e = h[c][0];
            n = Math.round(this.realXAxis.getCatPosition(e));
            e = Math.round(this.realYAxis.getPosition(l));
            var p = this._getPrevStackedPosition(s, f.index, q, i, this.realYAxis, l >= 0), v = e, r;
            if (e <= p)
                r = p - e;
            else {
                r = e - p;
            ...
            var o = d.actualValue, D = this._getStackedTotal(s, q), F = o > 0 ? D.positive : D.negative, x = F != 0 ? 100 * Math.abs(o) / Math.abs(F) : 0, t = { chart: this.chart, series: this, dataItem: h[c], index: c, value: o, x: h[c][0], y: l, percentage: x }, M = n - m / 2, j = new k(e, M, r, m);
            j.context = t;
            j.center = { x: Math.round(v), y: Math.round(n + m / 2) };
            this._setShapeSettings(j, c);
            C.push(j);
            this._addAnimation(j, f.index, f.count);
            if (this.markers && this.realYAxis.isValueVisible(l)) {
                var B = this._getMarker(v, n, null, l, null, c, t);
                A.push(B);
            ...
            if (this.labels && this.labels.visible !== false && d.actualValue != 0) {
                ...
                var y = this.labels.position == "outside", I = y ? H : -r / 2, g = this._getDataPointLabel(d.actualValue, v, n, I, w);
                if (!y) {
    ...
    qb.prototype._getPixelMargins = function (b) {
    ...
    G.prototype._renderCatData = function (v) {
        var g = this.arrData, w = this.chart.gridArea, o = this.categories, p = o.length, r = w.width / this.realXAxis.getZoom(), n = r / p, f = Math.round(this.pointWidth * n), u = Math.round((n - f) / 2);
        f = Math.max(f, this.minimumWidth);
        for (var q, j, l, c, h, i, b = 0; b < g.length; b++) {
            var e = g[b];
            if (e == null)
                continue;
            var m = a.inArray(e[0], o);
            if (m > -1)
                c = m;
            else
                c = b;
            h = e[1];
            i = e[2];
            q = Math.round(this.realXAxis.getCatPosition(c) + u);
            j = Math.round(this.realYAxis.getPosition(h));
            l = Math.round(this.realYAxis.getPosition(i));
            var s = { chart: this.chart, series: this, dataItem: g[b], index: b, catIndex: c, x: this.realXAxis._getValue(c), from: h, to: i }, x = Math.min(j, l), t = Math.abs(j - l), d = new k(q, x, f, t);
            d.context = s;
            this._setShapeSettings(d, b);
            v.push(d);
            this._addAnimation(d, b, p)
        }
    };
    G.prototype._renderLinearData = function (s) {
        var e = this.arrData, t = this.chart.gridArea, v = e.length, n = t.width / this.realXAxis.getZoom(), r = this._getSeriesFromThisType(), o = this._calcColumnScale(r) * n, d = this.pointWidth * o;
        d = Math.max(d, this.minimumWidth);
        for (var m, j, l, i, g, h, b = 0; b < v; b++) {
            var c = e[b];
            ...
            g = c[1];
            h = c[2];
            var p = { chart: this.chart, series: this, dataItem: e[b], index: b, catIndex: b, x: i, from: g, to: h };
            m = this.realXAxis.getPosition(i);
            j = Math.round(this.realYAxis.getPosition(g));
            l = Math.round(this.realYAxis.getPosition(h));
            var u = m - d / 2, w = Math.min(j, l), q = Math.abs(j - l), f = new k(u, w, d, q);
            f.context = p;
    ...
    t.prototype._renderCatData = function (u) {
        var g = this.arrData, v = this.chart.gridArea, o = this.categories, p = o.length, r = v.height / this.realXAxis.getZoom(), n = r / p, d = this.pointWidth * n, t = Math.round((n - d) / 2);
        d = Math.max(d, this.minimumWidth);
        for (var j, l, q, c, h, i, b = 0; b < g.length; b++) {
            var f = g[b];
            if (f == null)
                continue;
            var m = a.inArray(f[0], o);
            if (m > -1)
                c = m;
            else
                c = b;
            h = f[1];
            i = f[2];
            q = Math.round(this.realXAxis.getCatPosition(c) - t - d);
            j = Math.round(this.realYAxis.getPosition(h));
            l = Math.round(this.realYAxis.getPosition(i));
            var s = { chart: this.chart, series: this, dataItem: g[b], index: b, catIndex: c, x: this.realXAxis._getValue(c), from: h, to: i }, x = Math.min(j, l), w = Math.abs(j - l), e = new k(x, q, w, d);
            e.context = s;
            this._setShapeSettings(e, b);
            u.push(e);
            this._addAnimation(e, b, p)
        }
    };
    t.prototype._renderLinearData = function (s) {
        var f = this.arrData, t = this.chart.gridArea, m = f.length, o = t.height / this.realXAxis.getZoom(), r = this._getSeriesFromThisType(), q = this._calcColumnScale(r) * o, e = this.pointWidth * q;
        e = Math.max(e, this.minimumWidth);
        for (var j, l, n, i, g, h, b = 0; b < m; b++) {
            var c = f[b];
            if (c == null || a.isArray(c) == false)
                continue;
            i = c[0];
            g = c[1];
            h = c[2];
            var p = { chart: this.chart, series: this, dataItem: f[b], index: b, catIndex: b, x: i, from: g, to: h };
            n = this.realXAxis.getPosition(i);
            j = Math.round(this.realYAxis.getPosition(g));
            l = Math.round(this.realYAxis.getPosition(h));
            var v = n - e / 2, w = Math.min(j, l), u = Math.abs(j - l), d = new k(w, v, u, e);
            d.context = p;
            this._setShapeSettings(d, b);
            s.push(d);
            this._addAnimation(d, b, m)
        }
    };
    ...
    V.prototype._createYAxis = function () {
        var a = new p({ location: "bottom", orientation: "y" });
        a.chart = this.chart;
        return a
    };
    V.prototype._initData = function () {
    ...
    function F(b) {
        var c = a.extend(true, {}, this.defaults, { lineWidth: 2 });
        this.defaults = c;
        f.call(this, b)
    }
    F.prototype = new f;
    ...
    F.prototype._render = function (q) {
        ...
        if (!j || !this.isInScene())
            return;
        var r = this.chart.gridArea, k = j.length, d, f, h, g, e, m = r.width / this.realXAxis.getZoom(), i;
        if (this.xAxisType == "CategoryAxis")
            i = this.pointWidth * m / k;
        else {
            var o = this._calcColumnScale([this]) * m;
            i = this.pointWidth * o
        }
        for (var c = 0; c < k; c++) {
            var b = j[c];
            ...
            g = b[3];
            e = b[4];
            var p = { chart: this.chart, series: this, dataItem: b, index: c, x: this.realXAxis._getValue(n), high: f, low: h, open: g, close: e };
            ...
            var l = this._createShape(d, f, h, g, e, i);
            l.context = p;
            this._addShapeAnimation(l, c, k);
            q.push(l)
        }
    };
    ...
    function xb(b) {
        var c = a.extend(true, {}, this.defaults, { lineWidth: 1 });
        this.defaults = c;
        f.call(this, b)
    }
    xb.prototype = new F;
    ...
    I.prototype._render = function (l) {
        ...
        if (!m || !this.isInScene())
            return;
        for (var p = m.length, f = this.markers != null && this.markers.isVisible(), v = this.labels != null && this.labels.visible !== false, c = [], j = [], o = [], n = [], s = f ? this.markers.size / 2 : 0, h, i, e, u = this.realYAxis.cx, q = this.realYAxis.cy, d = 0; d < p; d++) {
            var g = m[d];
            if (g === null) {
                c.push(null);
                c.push(null);
            ...
            h = this.realYAxis.getPosition(e);
            i = q;
            var r = b.rotatePointAt(h, i, t, u, q);
            h = r.x;
            i = r.y;
            c.push(h);
            c.push(i);
            !f && j.push({ dataItem: g, index: d, x: this.realXAxis._getValue(d), y: e });
            this._addMarkerAndLabel(o, n, h, i, d, p, null, e, s)
        }
        var k = this._createShape(c);
        if (k) {
            l.push(k);
            if (!f)
                k.context = { chart: this.chart, series: this, points: j }
        }
        a.merge(l, o);
        a.merge(l, n)
    };
    ...
    D.prototype._render = function (n) {
        var k = this.arrData;
        if (!k || !this.isInScene())
            return;
        for (var q = k.length, g = this.markers != null && this.markers.isVisible(), w = this.labels != null && this.labels.visible !== false, c = [], j = [], p = [], o = [], t = g ? this.markers.size / 2 : 0, h, i, e, f, v = this.realYAxis.cx, r = this.realYAxis.cy, d = 0; d < q; d++) {
            var l = k[d];
            if (l === null) {
                c.push(null);
                c.push(null);
            ...
            h = this.realYAxis.getPosition(f);
            i = r;
            var s = b.rotatePointAt(h, i, u, v, r);
            h = s.x;
            i = s.y;
            c.push(h);
            c.push(i);
            var x = { chart: this.chart, series: this, dataItem: k[d], index: d, x: e, y: f };
            !g && j.push({ dataItem: l, index: d, x: e, y: f });
            this._addMarkerAndLabel(p, o, h, i, d, q, e, f, t)
        }
        var m = this._createShape(c);
        if (m) {
            n.push(m);
            if (!g)
                m.context = { chart: this.chart, series: this, points: j }
        }
        a.merge(n, p);
        a.merge(n, o)
    };
    ...
    function Gb(b) {
        var c = a.extend(true, {}, this.defaults, { lineWidth: 0, markers: { type: "diamond" } });
        this.defaults = c;
        f.call(this, b)
    }
    Gb.prototype = new D;
    ...
    function T(b) {
        var c = a.extend(true, {}, this.defaults, { lineWidth: 2, trendlineType: "linear", markers: {} });
        this.defaults = c;
        f.call(this, b)
    }
    T.prototype = new f;
    ...
    N.prototype._renderCatData = function (n) {
        for (var o = this.arrData, p = o.length, f = this.markers != null && this.markers.isVisible(), c = [], i = [], m = [], k = [], r = f ? this.markers.size / 2 : 0, h, j, q, d, e = 0; e < p; e++) {
            var g = o[e];
            if (g === null) {
                c.push(null);
                c.push(null);
            ...
            j = this.realXAxis.getPosition(h);
            h = this.realYAxis.getPosition(d);
            c.push(h);
            c.push(j);
            !f && i.push({ dataItem: g, index: e, x: q, y: d });
            if (this.realYAxis.isValueVisible(d) === false)
                continue;
            this._addMarkerAndLabel(m, k, h, j, e, p, null, d, r)
        }
        var l = this._createShape(c, n);
        if (!f && l)
            l.context = { chart: this.chart, series: this, points: i };
    ...
    N.prototype._renderLinearData = function (o) {
        for (var p = this.arrData, q = p.length, e = this.markers != null && this.markers.isVisible(), s = this.labels != null && this.labels.visible !== false, c = [], h = [], n = [], l = [], r = e ? this.markers.size / 2 : 0, j, k, f, d, g = 0; g < q; g++) {
            var i = p[g];
            if (i === null) {
                c.push(null);
                c.push(null);
            ...
            c.push(j);
            c.push(k);
            !e && h.push({ dataItem: i, index: g, x: f, y: d });
            if (this.realYAxis.isValueVisible(d) === false)
                continue;
            this._addMarkerAndLabel(n, l, j, k, g, q, f, d, r)
        }
        var m = this._createShape(c, o);
        if (!e && m)
            m.context = { chart: this.chart, series: this, points: h };
        else
            a.merge(o, n);
        return l
    };
    ...
    y.prototype._renderCatData = function (r) {
        for (var s = this.arrData, k = s.length, e = this.markers != null && this.markers.isVisible(), c = [], d = [], f = [], q = [], o = [], t = e ? this.markers.size / 2 : 0, j, m, n, l, g, h, b = 0; b < k; b++) {
            var i = s[b];
            if (i === null) {
                c.push(null);
                c.push(null);
            ...
            g = i[1];
            h = i[2];
            j = this.realXAxis.getPosition(l);
            m = this.realYAxis.getPosition(g);
            n = this.realYAxis.getPosition(h);
            c.push(j);
            c.push(m);
            d.push(j);
            d.push(n);
            if (!e)
                f[b] = f[2 * k - b - 1] = { dataItem: i, index: b, x: l, from: g, to: h };
            this._addMarkersAndLabels(q, o, j, m, n, b, k, null, g, h, t)
        }
        var p = this._createShape(c, d, r);
        if (!e && p)
            p.context = { chart: this.chart, series: this, points: f };
        else
            a.merge(r, q);
        return o
    };
    y.prototype._renderLinearData = function (r) {
        for (var s = this.arrData, k = s.length, d = this.markers != null && this.markers.isVisible(), u = this.labels != null && this.labels.visible !== false, i = [], j = [], e = [], q = [], o = [], t = d ? this.markers.size / 2 : 0, h, m, n, l, f, g, b = 0; b < k; b++) {
            var c = s[b];
            if (c === null) {
                pts.push(null);
                pts.push(null);
            ...
            f = c[1];
            g = c[2];
            h = this.realXAxis.getPosition(l);
            ...
            j.push(n);
            if (!d)
                e[b] = e[2 * k - b - 1] = { dataItem: c, index: b, x: l, from: f, to: g };
            this._addMarkersAndLabels(q, o, h, m, n, b, k, null, f, g, t)
        }
        var p = this._createShape(i, j, r);
        if (!d && p)
            p.context = { chart: this.chart, series: this, points: e };
        else
            a.merge(r, q);
        return o
    };
    ...
    y.prototype._addMarkersAndLabels = function (g, n, i, p, q, a, h, o, d, e, m) {
        var k = 0, r = o ? o : a;
        if (this.markers && this.markers.isVisible()) {
            var f = { chart: this.chart, series: this, dataItem: data[a], index: a, x: this.realXAxis._getValue(r), from: d, to: e };
            k = this.markers.offset;
            var l = f.dataItem[3], b = this._addMarker(i, p, null, d, l, a, f);
            if (b.marker) {
                b.line && g.push(b.line);
                g.push(b.marker);
                this._addShapeAnimation(b.marker, a, h)
            }
            b = this._addMarker(i, q, null, e, l, a, f);
            if (b.marker) {
                b.line && g.push(b.line);
                g.push(b.marker);
                this._addShapeAnimation(b.marker, a, h)
        ...
        if (this.labels && this.labels.visible !== false) {
            var j = this._getLabelValue(d, a), c = this._getDataPointLabel(d, i, p, m + k, j, d > e), f = { chart: this.chart, series: this, dataItem: data[a], index: a };
            c.context = f;
            this.chart.elem.trigger("dataPointLabelCreating", c);
            n.push(c);
            this._addShapeAnimation(c, a, h);
            j = this._getLabelValue(e, a);
            c = this._getDataPointLabel(e, i, q, m + k, j, e > d);
            c.context = f;
            this.chart.elem.trigger("dataPointLabelCreating", c);
            n.push(c);
            this._addShapeAnimation(c, a, h)
    ...
    y.prototype._getDataPointLabel = function (j, i, e, c, f, g) {
        var h = this._getLabelText(f), b = new l(h);
        d.setShadows(b, this, this.chart);
        a.extend(b, this.labels);
        b.measure(this.chart.ctx);
        b.textAlign = "center";
    ...
    r.prototype._render = function (g) {
        ...
        return { postShapes: e, contextShapes: d }
    };
    ...
    n.prototype._initDefs = function () {
        jb.prototype._initDefs.call(this);
        var b = a.extend(true, {}, this.defaults, { rangeSlider: { visible: true, breadth: 20 }, margin: 5, strokeStyle: "black", lineWidth: 1, zoomEnabled: false, visible: true });
        this.defaults = b
    };
    ...
    n.prototype._setVisibleRanges = function () {
        jb.prototype._setVisibleRanges.call(this);
        if (!this.jqRangeSlider)
            return;
        var a = (this.actualMaximum - this.actualMinimum) / 10;
        this.jqRangeSlider.jqRangeSlider("update", { minimum: this.actualMinimum, maximum: this.actualMaximum, smallChange: a, largeChange: 2 * a, minRange: a / 100, range: { minimum: this.actualVisibleMinimum, maximum: this.actualVisibleMaximum } })
    };
    n.prototype._arrange = function () {
        jb.prototype._arrange.call(this);
        if (!this.zoomEnabled) {
            this.clear();
            return
        }
        ...
        var e = this.offset;
        if (!this.jqRangeSlider) {
            var d = a('<div style="position:absolute"></div>').jqRangeSlider({}), f = this;
        ...
        switch (this.location) {
            case "left":
                b = { left: this.x + this.width - e, top: this.y, width: c, height: this.height };
                break;
            case "right":
                b = { left: this.x + this.lineWidth / 2, top: this.y, width: c, height: this.height };
                break;
            case "top":
                b = { left: this.x, top: this.y + this.height - e, width: this.width, height: c };
                break;
            case "bottom":
                b = { left: this.x, top: this.y + this.lineWidth / 2, width: this.width, height: c }
        }
        if (b) {
            var g = this.isAxisVertical ? "vertical" : "horizontal";
            this.jqRangeSlider.css(b).jqRangeSlider("update", { orientation: g, reversed: this.reversed })
            if (this.background) {
                this.jqRangeSlider.find(".ui-widget-header").css('background', this.background);
                this.jqRangeSlider.find(".ui-widget-header").css('border-color', this.background);
            }
        }
    };
    ...
    n.prototype._mouseWheelZoom = function (f) {
        var b = this.actualVisibleMinimum, a = this.actualVisibleMaximum, c = (this.actualMaximum - this.actualMinimum) / 1e3, e = f * 50 * c;
    ...
    n.prototype._mouseWheelScroll = function (d) {
        var c = this.actualVisibleMinimum, b = this.actualVisibleMaximum, a = d * (this.actualMaximum - this.actualMinimum) / 20;
    ...
    n.prototype._zoom = function () {
        this.chart.elem.trigger("axisZoom", { chart: this.chart, axis: this })
    };
    n.prototype._getTooltip = function (a) {
        return "<b>" + a + "</b><br/>"
    };
    n.prototype.getCatPosition = function (a) {
        return jb.prototype.getPosition.call(this, a)
    };
    ...
    o.prototype._initDefs = function () {
        ...
        var b = a.extend(true, {}, this.defaults, { extendRangeToOrigin: false, logarithmic: false, logBase: 10, labels: { resolveOverlappingMode: "hide" } });
        this.defaults = b
    };
    o.prototype._initRange = function () {
        ...
        var r = this._addPlotsInRange(e, c);
        e = r.min;
        c = r.max;
        if (!b.isNull(this.minimum))
            e = this.minimum;
        ...
        var o = 0, n = 0, f = h._getPixelMargins(this);
        if (this.isAxisVertical) {
        ...
        var a = e - o, d = c + n, t = this.series._isAnchoredToOrigin(), g = this.getCrossing();
        ...
        if (this.logarithmic === true) {
            ...
            var l = this._calculateActualIntervalLogarithmic(a, d);
            a = b.round(Math.floor(a / l) * l);
            d = b.round(Math.ceil(d / l) * l)
        }
    ...
    o.prototype._getIntervals = function (c, a, h) {
        ...
        if (this.logarithmic === false)
            return n.prototype._getIntervals.call(this, c, a);
        if (h === false)
    ...
    p.prototype = new o;
    p.constructor = p;
    p.prototype._initDefs = function () {
        o.prototype._initDefs.call(this);
        var b = a.jqChartDateFormat.masks, c = a.extend(true, {}, this.defaults, { labels: { yearsIntervalStringFormat: "yyyy", monthsIntervalStringFormat: b.shortDate, weeksIntervalStringFormat: b.shortDate, daysIntervalStringFormat: b.shortDate, hoursIntervalStringFormat: b.shortDate + " " + b.shortTime, minutesIntervalStringFormat: b.shortTime, secondsIntervalStringFormat: b.longTime, millisecondsIntervalStringFormat: b.longTime }, skipEmptyDays: false });
        this.defaults = c
    };
    p.prototype._initRange = function () {
        if (this.skipEmptyDays) {
    ...
    p.prototype._setMinMax = function (c, b) {
    ...
    p.prototype._calculateActualInterval = function (c, b) {
        if (this.skipEmptyDays)
    ...
    p.prototype._calculateDateTimeInterval = function (j, i) {
    ...
    p.prototype._getNextPosition = function (b, a) {
        return this._incrementDateTime(b, a, this.actualIntervalType)
    };
    p.prototype._incrementDateTime = function (h, b, c) {
    ...
    p.prototype._getIntervalStart = function (j, b, d) {
        if (d == null)
            return j;
        var a = new Date(j);
        if (b > 0 && b != 1)
    ...
    p.prototype._initActualStringFormat = function () {
        if (!this.labels || this.labels.visible === false)
            return;
    ...
    p.prototype._getIntervals = function (f, c) {
        if (this.customTickMarks)
            return this.customTickMarks;
    ...
    p.prototype._getIntervalCount = function () {
        var a = this.actualMaximum - this.actualMinimum;
        a = Math.ceil(a / g.ticksInDay);
        return a
    };
    p.prototype._getNextNonEmptyDay = function (b) {
        if (!this.emptyDays)
            return b;
        var d = a.inArray(b, this.emptyDays);
        if (d == -1)
            return b;
        var h = g.addDays(new Date(b), 1), f = this.actualMaximum;
        if (this.skipEmptyDays)
            f += this.totalEmptyDaysTicks;
        for (var c = h; c <= f; c = g.addDays(c, 1)) {
            var e = c.getTime();
    ...
    p.prototype._getEmptyDaysOffset = function (c) {
        if (!this.emptyDays)
            return 0;
    ...
    p.prototype._addEmptyDaysOffset = function (c) {
        if (b.isNull(c))
            return null;
    ...
    p.prototype._getEmptyDays = function () {
    ...
    p.prototype._getEmptyDaysFromSeries = function (i) {
        var f = [], b = [];
        a.merge(b, i.arrData);
        b.sort(function (a, b) {
            return a[0] - b[0]
    ...
    p.prototype._excludeDaysFromSeries = function (c, b) {
        a.each(c.arrData, function (f, d) {
            var e = g.roundToDay(d[0]).getTime(), c = a.inArray(e, b);
            c != -1 && b.splice(c, 1)
        })
    };
    p.prototype._getTooltip = function (b) {
    ...
    p.prototype.getPosition = function (b) {
        if (a.type(b) == "date")
            b = b.getTime();
        var c = 0;
        if (this.skipEmptyDays)
    ...
    p.prototype.getLabel = function (b) {
    ...
    w.prototype._initDefs = function () {
        o.prototype._initDefs.call(this);
        var b = a.extend(true, {}, this.defaults, { innerExtent: .2, renderStyle: "circle", majorTickMarks: { visible: false }, location: "radial", majorGridLines: { strokeStyle: "gray", lineWidth: 1, visible: true } });
        this.defaults = b
    };
    ...
    w.prototype._getTickMarks = function (a, l) {
        ...
        for (var h = [], s = this._getMarkInterval(a, l), t = a.length, k = this._getIntervals(s, a, l), g = this.sharedAxis, f = g._getIntervals(g.actualInterval), p, r, q, c, d = 0; d < k.length; d++) {
            ...
            for (var e = 0; e < f.length; e++) {
                var v = f[e], j = this.sharedAxis._getAngle(v), n = b.rotatePointAt(p, r, j, this.cx, this.cy), o = b.rotatePointAt(q, c, j, this.cx, this.cy), m = new i(n.x, n.y, o.x, o.y);
    ...
    w.prototype._render = function (d) {
        ...
        a.merge(c, e);
        return { postShapes: c, contextShapes: e }
    };
    ...
    L.prototype._initDefs = function () {
        n.prototype._initDefs.call(this);
        var b = a.extend(true, {}, this.defaults, { strokeStyle: "gray", renderLinesOverGraph: true, location: "radial" });
        this.defaults = b
    };
    ...
    L.prototype._render = function (n) {
        ...
        for (var d = this.cx, e = this.cy, q = d, s = e - this.sharedAxis.extent, r = d, t = e - this.radius, o = this.renderLinesOverGraph, p = 2 * Math.PI / g, h = 0; h < g; h++) {
            var k = h * p, l = b.rotatePointAt(q, s, k, d, e), m = b.rotatePointAt(r, t, k, d, e), c = new i(l.x, l.y, m.x, m.y);
            c.strokeStyle = this.strokeStyle;
            c.lineWidth = this.lineWidth;
            c.strokeDashArray = this.strokeDashArray;
            if (o)
        ...
        a.merge(f, j);
        return { postShapes: f, contextShapes: j }
    };
    function C(a) {
        n.call(this, a);
    ...
    C.prototype._initDefs = function () {
        n.prototype._initDefs.call(this);
        var b = a.extend(true, {}, this.defaults, { minimum: 0, maximum: 360, startAngle: 0, endAngle: 360, renderLinesOverGraph: true, strokeStyle: "gray" });
        this.defaults = b
    };
    ...
    C.prototype._render = function (o) {
        ...
        for (var t = d, u = e - this.radius, p = this.renderLinesOverGraph, k = this._getIntervals(this.actualInterval), q = this._getIntervalsLength(k), g = 0; g < q; g++) {
            var r = k[g], j = this._getAngle(r) + Math.PI / 2, l = b.rotatePointAt(s, n, j, d, e), m = b.rotatePointAt(t, u, j, d, e), c = new i(l.x, l.y, m.x, m.y);
            c.strokeStyle = this.strokeStyle;
            c.lineWidth = this.lineWidth;
            c.strokeDashArray = this.strokeDashArray;
            if (p)
        ...
        a.merge(f, h);
        return { postShapes: f, contextShapes: h }
    };
    function ub(b, a) {
        this.series = b;
        this.defaults = { calculationType: "standardError", displayType: "both", value: 10, strokeStyle: "black", lineWidth: 2, capLength: 10 };
        this.setOptions(a);
    ...
    ub.prototype._getYValues = function () {
    ...
    ub.prototype._calculateErrorAmount = function () {
        var o = this.series;
        if (!o.arrData)
            return 0;
        var e = this._getYValues(o), a = e.length;
        switch (this.calculationType) {
            case "standardError":
                if (a <= 1)
                    return 0;
                for (var g = 0, c = 0; c < a; c++)
                    g += Math.pow(e[c], 2);
            ...
            case "standardDeviation":
                if (a <= 1)
                    return 0;
                for (var s = b.sum(e), r = s / a, f = 0, c = 0; c < a; c++)
                    f += Math.pow(e[c] - r, 2);
                f = Math.sqrt(f / (a - 1));
                return f;
            case "percentage":
    ...
    ub.prototype._createShapes = function (n) {
        for (var f = this.series, y = f.isVertical, x = f.arrData, A = x.length, z = f.xAxisType, m, o, h, c, p, q, d, r, s, v, w, e, j, k, g = this.displayType, u = this.errorAmount, l = this.capLength / 2, t = 0; t < x.length; t++) {
            ...
            if (b.isNull(o) || b.isNull(h))
                continue;
            if (this.calculationType == "percentage")
                u = Math.abs(h) * this.value / 100;
            v = h - u;
            w = h + u;
            if (y) {
    ...
    function Xb(a) {
        this.defaults = { marker: { visible: true, type: "cross", fillStyle: "red", strokeStyle: "red", lineWidth: 4, size: 10 }, fillStyle: "#cccccc", strokeStyle: "red", lineWidth: 2 };
        this.setOptions(a)
    }
